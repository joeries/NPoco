...
namespace NPoco
{
    public class PocoColumn
    {
        ...
        /// <summary>
        /// //Updated by ZofX because of that the identity colunm type is Int32/Int64.
        /// </summary>
        /// <param name="val"></param>
        /// <returns></returns>
        public virtual object ChangeType(object val)
        {
            if (MemberInfoData.MemberType.FullName.Contains("System.Int32"))
            {
                return Convert.ToInt32(val);
            }
            else if (MemberInfoData.MemberType.FullName.Contains("System.Int64"))
            {
                return Convert.ToInt64(val);
            }
            else
            {
                return Convert.ChangeType(val, MemberInfoData.MemberType);
            }
        }
