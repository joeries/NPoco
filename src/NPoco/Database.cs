...
namespace NPoco
{
    public partial class Database : IDatabase
    {
        ...
        public virtual void AddParameter(DbCommand cmd, object value)
        {
            ...
            System.Data.OleDb.OleDbParameter oleDbParameter = p as System.Data.OleDb.OleDbParameter;
            if (null != oleDbParameter && oleDbParameter.OleDbType == System.Data.OleDb.OleDbType.DBTimeStamp)
            {
                oleDbParameter.OleDbType = System.Data.OleDb.OleDbType.Date;
            }
        ...
        public void BuildPageQueries<T>(long skip, long take, string sql, ref object[] args, out string sqlCount, out string sqlPage)
        {
            ...
            if (null != objs)
            {
                PrimaryKeyAttribute attrPrimaryKey;
                foreach (object obj in objs)
                {
                    attrPrimaryKey = obj as PrimaryKeyAttribute;
                    if (null != attrPrimaryKey)
                    {
                        primaryKey = attrPrimaryKey.Value;
                        break;
                    }
                }
            }
            sqlPage = _dbType.BuildPageQuery(skip, take, parts, ref args, primaryKey);
