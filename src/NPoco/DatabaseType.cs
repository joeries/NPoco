...
namespace NPoco
{
    ...
    public abstract class DatabaseType
    {
        ...
        public virtual string BuildPageQuery(long skip, long take, PagingHelper.SQLParts parts, ref object[] args, string primaryKey = "")
        {
        ...
        public static DatabaseType Resolve(string typeName, string providerName)
        {
            ...
            if (typeName.StartsWith("OleDb"))
                return Singleton<OleDbDatabaseType>.Instance;
